...
oFF.HttpCoreUtils = {
	...
	setLanguage:function(systemDescription, httpHeader)
	{
		...
		var normalizeLanguage = oFF.HttpCoreUtils.normalizeLanguage(lang);
	...
	{
			var normalizedLang = null;
		if (!oFF.XStringUtils.isNullOrEmpty(lang))
		{
			var index = oFF.XString.indexOf(lang, "-");
			var mainLang = lang;
			var subLang = null;
			if (index !== -1)
			{
				...
				var spaceIndex = oFF.XString.indexOf(subLang, " ");
				if (spaceIndex !== -1)
				{
...
oFF.SyncActionProxy = function() {};
oFF.SyncActionProxy.prototype = new oFF.XObject();
oFF.SyncActionProxy.prototype._ff_c = "SyncActionProxy";

oFF.SyncActionProxy.create = function(originSyncAction)
{
	var syncAction = new oFF.SyncActionProxy();
	syncAction.m_originSyncAction = originSyncAction;
	return syncAction;
};
oFF.SyncActionProxy.prototype.m_originSyncAction = null;
oFF.SyncActionProxy.prototype.getData = function()
{
	var data = this.m_originSyncAction.getData();
	return data;
};
oFF.SyncActionProxy.prototype.isValid = function()
{
	return this.m_originSyncAction.isValid();
};
oFF.SyncActionProxy.prototype.hasErrors = function()
{
	return this.m_originSyncAction.hasErrors();
};
oFF.SyncActionProxy.prototype.hasWarnings = function()
{
	return this.m_originSyncAction.hasWarnings();
};
oFF.SyncActionProxy.prototype.getNumberOfErrors = function()
{
	return this.m_originSyncAction.getNumberOfErrors();
};
oFF.SyncActionProxy.prototype.getNumberOfWarnings = function()
{
	return this.m_originSyncAction.getNumberOfWarnings();
};
oFF.SyncActionProxy.prototype.hasSeverity = function(severity)
{
	return this.m_originSyncAction.hasSeverity(severity);
};
oFF.SyncActionProxy.prototype.getNumberOfSeverity = function(severity)
{
	return this.m_originSyncAction.getNumberOfSeverity(severity);
};
oFF.SyncActionProxy.prototype.getFirstWithSeverity = function(severity)
{
	return this.m_originSyncAction.getFirstWithSeverity(severity);
};
oFF.SyncActionProxy.prototype.getErrors = function()
{
	return this.m_originSyncAction.getErrors();
};
oFF.SyncActionProxy.prototype.getWarnings = function()
{
	return this.m_originSyncAction.getWarnings();
};
oFF.SyncActionProxy.prototype.getInfos = function()
{
	return this.m_originSyncAction.getInfos();
};
oFF.SyncActionProxy.prototype.getSemanticalErrors = function()
{
	return this.m_originSyncAction.getSemanticalErrors();
};
oFF.SyncActionProxy.prototype.getMessages = function()
{
	return this.m_originSyncAction.getMessages();
};
oFF.SyncActionProxy.prototype.containsCode = function(severity, code)
{
	return this.m_originSyncAction.containsCode(severity, code);
};
oFF.SyncActionProxy.prototype.getMessage = function(severity, code)
{
	return this.m_originSyncAction.getMessage(severity, code);
};
oFF.SyncActionProxy.prototype.getFirstError = function()
{
	return this.m_originSyncAction.getFirstError();
};
oFF.SyncActionProxy.prototype.getRootProfileNode = function()
{
	return this.m_originSyncAction.getRootProfileNode();
};
oFF.SyncActionProxy.prototype.getSummary = function()
{
	return this.m_originSyncAction.getSummary();
};
oFF.SyncActionProxy.prototype.getClientStatusCode = function()
{
	return this.m_originSyncAction.getClientStatusCode();
};
oFF.SyncActionProxy.prototype.getServerStatusCode = function()
{
	return this.m_originSyncAction.getServerStatusCode();
};
oFF.SyncActionProxy.prototype.getServerStatusDetails = function()
{
	return this.m_originSyncAction.getServerStatusDetails();
};
oFF.SyncActionProxy.prototype.isSyncCanceled = function()
{
	return this.m_originSyncAction.isSyncCanceled();
};
oFF.SyncActionProxy.prototype.cancelSynchronization = function()
{
	this.m_originSyncAction.cancelSynchronization();
};
oFF.SyncActionProxy.prototype.attachListener = function(listener, type, customIdentifier)
{
	this.m_originSyncAction.attachListener(listener, type, customIdentifier);
};
oFF.SyncActionProxy.prototype.thenDo = function(successListener, failureListener)
{
	this.m_originSyncAction.thenDo(successListener, failureListener);
};
oFF.SyncActionProxy.prototype.getSyncState = function()
{
	return this.m_originSyncAction.getSyncState();
};

oFF.SyncActionProxy2 = function() {};
oFF.SyncActionProxy2.prototype = new oFF.XObject();
oFF.SyncActionProxy2.prototype._ff_c = "SyncActionProxy2";

oFF.SyncActionProxy2.create = function(originSyncAction)
{
	var syncAction = new oFF.SyncActionProxy2();
	syncAction.m_originSyncAction = originSyncAction;
	return syncAction;
};
oFF.SyncActionProxy2.prototype.m_originSyncAction = null;
oFF.SyncActionProxy2.prototype.getData = function()
{
	var data = this.m_originSyncAction.getData();
	return data;
};
oFF.SyncActionProxy2.prototype.isValid = function()
{
	return this.m_originSyncAction.isValid();
};
oFF.SyncActionProxy2.prototype.hasErrors = function()
{
	return this.m_originSyncAction.hasErrors();
};
oFF.SyncActionProxy2.prototype.hasWarnings = function()
{
	return this.m_originSyncAction.hasWarnings();
};
oFF.SyncActionProxy2.prototype.getNumberOfErrors = function()
{
	return this.m_originSyncAction.getNumberOfErrors();
};
oFF.SyncActionProxy2.prototype.getNumberOfWarnings = function()
{
	return this.m_originSyncAction.getNumberOfWarnings();
};
oFF.SyncActionProxy2.prototype.hasSeverity = function(severity)
{
	return this.m_originSyncAction.hasSeverity(severity);
};
oFF.SyncActionProxy2.prototype.getNumberOfSeverity = function(severity)
{
	return this.m_originSyncAction.getNumberOfSeverity(severity);
};
oFF.SyncActionProxy2.prototype.getFirstWithSeverity = function(severity)
{
	return this.m_originSyncAction.getFirstWithSeverity(severity);
};
oFF.SyncActionProxy2.prototype.getErrors = function()
{
	return this.m_originSyncAction.getErrors();
};
oFF.SyncActionProxy2.prototype.getWarnings = function()
{
	return this.m_originSyncAction.getWarnings();
};
oFF.SyncActionProxy2.prototype.getInfos = function()
{
	return this.m_originSyncAction.getInfos();
};
oFF.SyncActionProxy2.prototype.getSemanticalErrors = function()
{
	return this.m_originSyncAction.getSemanticalErrors();
};
oFF.SyncActionProxy2.prototype.getMessages = function()
{
	return this.m_originSyncAction.getMessages();
};
oFF.SyncActionProxy2.prototype.containsCode = function(severity, code)
{
	return this.m_originSyncAction.containsCode(severity, code);
};
oFF.SyncActionProxy2.prototype.getMessage = function(severity, code)
{
	return this.m_originSyncAction.getMessage(severity, code);
};
oFF.SyncActionProxy2.prototype.getFirstError = function()
{
	return this.m_originSyncAction.getFirstError();
};
oFF.SyncActionProxy2.prototype.getRootProfileNode = function()
{
	return this.m_originSyncAction.getRootProfileNode();
};
oFF.SyncActionProxy2.prototype.getSummary = function()
{
	return this.m_originSyncAction.getSummary();
};
oFF.SyncActionProxy2.prototype.getClientStatusCode = function()
{
	return this.m_originSyncAction.getClientStatusCode();
};
oFF.SyncActionProxy2.prototype.getServerStatusCode = function()
{
	return this.m_originSyncAction.getServerStatusCode();
};
oFF.SyncActionProxy2.prototype.getServerStatusDetails = function()
{
	return this.m_originSyncAction.getServerStatusDetails();
};
oFF.SyncActionProxy2.prototype.isSyncCanceled = function()
{
	return this.m_originSyncAction.isSyncCanceled();
};
oFF.SyncActionProxy2.prototype.cancelSynchronization = function()
{
	this.m_originSyncAction.cancelSynchronization();
};
oFF.SyncActionProxy2.prototype.attachListener = function(listener, type, customIdentifier)
{
	this.m_originSyncAction.attachListener(listener, type, customIdentifier);
};
oFF.SyncActionProxy2.prototype.thenDo = function(successListener, failureListener)
{
	this.m_originSyncAction.thenDo(successListener, failureListener);
};
oFF.SyncActionProxy2.prototype.getSyncState = function()
{
	return this.m_originSyncAction.getSyncState();
};
...
{
	var currentPathList = oFF.XListOfString.createFromReadOnlyList(this.getPathNames());
	if (this.isFile())
	{
		oFF.XPath.removeLastElement(currentPathList);
	}
	var targetPathList = target.getPathNames();
...
oFF.XNotificationCenter.prototype.m_allObserverConsumerMap = null;
oFF.XNotificationCenter.prototype.releaseObject = function()
{
	...
	this.m_allObserverConsumerMap = oFF.XCollectionUtils.releaseEntriesAndCollectionIfNotNull(this.m_allObserverConsumerMap);
...
oFF.XNotificationCenter.prototype.setupCenter = function()
{
	...
	this.m_allObserverConsumerMap = oFF.XHashMapByString.create();
};
...
oFF.XNotificationCenter.prototype.addAllObserverConsumer = function(consumer)
{
	var observerUuid = oFF.XGuid.getGuid();
	observerUuid = oFF.XStringUtils.concatenate2("ncAllObserver_", observerUuid);
	this.m_allObserverConsumerMap.put(observerUuid, oFF.XBiConsumerHolder.create(consumer));
	return observerUuid;
};
oFF.XNotificationCenter.prototype.removeAllObserverByUuid = function(uuid)
{
	this.m_allObserverConsumerMap.remove(uuid);
};
oFF.XNotificationCenter.prototype._callAllObserversIfNeeded = function(notifyName, notifyData)
{
	oFF.XCollectionUtils.forEach(this.m_allObserverConsumerMap,  function(allConsumer){
		allConsumer.accept(notifyName, notifyData);
	}.bind(this));
};
...
{
	var value = 0;
	var integerValue = this.m_deleteCounter.getByKey(namespace);
	if (oFF.notNull(integerValue))
	{
		value = integerValue.getInteger();
	}
...
oFF.DfXFileSystemOS.prototype.renameTo2 = function(sourceNativePath, destNativeName)
{
	...
	var last = oFF.XString.lastIndexOf(sourceNativePath, nativeSlash);
	var parent = oFF.XString.substring(sourceNativePath, 0, last);
	var destNativePath = oFF.XStringUtils.concatenate3(parent, nativeSlash, destNativeName);
...
oFF.IoSession.prototype.setupIoSession = function(parent, environmentConfig, dateTimeProvider)
{
	...
	if (oFF.isNull(parent))
	{
		...
		if (oFF.XStringUtils.isNotNullAndNotEmpty(featureToggleList))
		{
			...
			for (var m = 0; m < listOfToggles.size(); m++)
			{
				...
				var toggleConstant = oFF.FeatureToggle.lookup(singleToggleClean);
	...
	else
	{
		...
		this.m_featureToggles.addAll(parent.getFeatureTogglesByName());
	}
...
{
	var toggleSet = oFF.XSetOfNameObject.create();
	var iterator = this.m_featureToggles.getIterator();
	while (iterator.hasNext())
	{
		var toggleName = iterator.next();
		var featureToggle = oFF.FeatureToggle.lookup(toggleName);
...
{
	var result;
	var featureToggle = oFF.FeatureToggle.lookup(featureToggleName);
	if (oFF.notNull(featureToggle))
	{
...
{
	var keys = featureToggles.getKeysAsReadOnlyListOfString();
...
{
	var target = oFF.XHashSetOfString.create();
	var keys = this.m_featureToggles.getValuesAsReadOnlyListOfString();
...
{
	var object = new oFF.XCacheProviderDeleteAction();
...
oFF.FeatureToggleIO.SERVER_METADATA_VIA_SYSTEM_CONNECT = null;
...
oFF.FeatureToggleIO.staticSetup = function()
{
	...
	oFF.FeatureToggleIO.SERVER_METADATA_VIA_SYSTEM_CONNECT = oFF.FeatureToggleIO.create("ServerMetadataViaSystemConnect", oFF.XVersion.V202_SERVER_METADATA_VIA_SYSTEM_CONNECT);
...
{
	var newObj = new oFF.FeatureToggleIO();
	var fullName = oFF.XStringUtils.concatenate2(oFF.FeatureToggleIO.PREFIX_RPC, name);
...
{
	oFF.FeatureToggleOlap.SHARED_CSRF_TOKENS = oFF.FeatureToggleIO.SHARED_CSRF_TOKENS;
	oFF.FeatureToggleOlap.AUTO_CSRF_CALL = oFF.FeatureToggleIO.AUTO_CSRF_CALL;
	oFF.FeatureToggleOlap.SERVER_METADATA_VIA_SYSTEM_CONNECT = oFF.FeatureToggleIO.SERVER_METADATA_VIA_SYSTEM_CONNECT;
	oFF.FeatureToggleOlap.BW_SESSION_ID_VIA_GET_RESPONSE = oFF.FeatureToggleIO.BW_SESSION_ID_VIA_GET_RESPONSE;
	oFF.FeatureToggleOlap.SORT_NEW_VALUES = oFF.FeatureToggleOlap.create("SortNewValues", -2);
	oFF.FeatureToggleOlap.ROOT_ORPHANS_AFTER_VISIBILITY_FILTER = oFF.FeatureToggleOlap.create("RootOrphanNodesAfterVisibilityFilter", -2);
	oFF.FeatureToggleOlap.MDS_CONDITIONS = oFF.FeatureToggleOlap.create("Conditions", -2);
	oFF.FeatureToggleOlap.IS_VIRTUAL_DESCRIPTION = oFF.FeatureToggleOlap.create("IsVirtualDescription", -2);
	oFF.FeatureToggleOlap.MEASURE_MEMBER_DEFINITION = oFF.FeatureToggleOlap.create("MeasureMemberMetadata", -2);
	oFF.FeatureToggleOlap.MEASURE_MEMBER_DETAILS = oFF.FeatureToggleOlap.create("MeasureMemberDetails", -2);
	oFF.FeatureToggleOlap.MEASURE_MEMBER_TYPE = oFF.FeatureToggleOlap.create("CustomDimension1MemberType", -2);
	oFF.FeatureToggleOlap.CURRENCY_TRANSLATION = oFF.FeatureToggleOlap.create("CurrencyTranslation", -2);
	oFF.FeatureToggleOlap.MEASURE_MEMBER_CURRENCY_TRANSLATIONS = oFF.FeatureToggleOlap.create("MeasureMemberCurrencyTranslations", -2);
	oFF.FeatureToggleOlap.UNDEFINED_TUPLE_COUNT_TOTALS = oFF.FeatureToggleOlap.create("UndefinedTupleCountTotals", -2);
	oFF.FeatureToggleOlap.SFX_DIMENSION_CUSTOMIZED_DESC = oFF.FeatureToggleOlap.create("SfxDimensionCustomizedDesc", -2);
	oFF.FeatureToggleOlap.UNIVERSAL_MODEL = oFF.FeatureToggleOlap.create("UniversalModel", -2);
	oFF.FeatureToggleOlap.INIT_ACTION_FOR_FUSION = oFF.FeatureToggleOlap.create("InitActionForFusion", -2);
	oFF.FeatureToggleOlap.SET_OPERAND_CURRENT_MEMBER_SINGLE_NAVIGATION = oFF.FeatureToggleOlap.create("SetOperandCurrentMemberSingleNavigation", -2);
	oFF.FeatureToggleOlap.MULTIPLE_EX_AGG_DIMS_IN_CALC_PLAN = oFF.FeatureToggleOlap.create("MultipleExAggDimsInCalcPlan", oFF.XVersion.V126_MULTIPLE_EX_AGG_DIMS_IN_CALC_PLAN);
	...
	oFF.FeatureToggleOlap.EXPORT_FREE_AXIS_FOR_PLANNING = oFF.FeatureToggleOlap.create("FreeAxisForPlanning", oFF.XVersion.V170_EXPORT_FREE_AXIS_FOR_PLANNING);
	...
	oFF.FeatureToggleOlap.SFX_HIDDEN_DIMENSIONS = oFF.FeatureToggleOlap.create("SfxHiddenDimensions", oFF.XVersion.V284_SFX_HIDDEN_DIMENSIONS);
	...
	oFF.FeatureToggleOlap.AUTO_VARIABLE_SUBMIT_FOR_FULL_QM = oFF.FeatureToggleOlap.create("AutoVarSubmitFullQM", oFF.XVersion.V287_AUTO_VARIABLE_SUBMIT_FUNCTIONALITY);
	oFF.FeatureToggleOlap.PREREQUISITE_FOR_AUTO_SUBMIT_AFTER_SUBMITTED = oFF.FeatureToggleOlap.create("AutoSubmitAfterSubmittedPrerequisite", oFF.XVersion.V287_AUTO_VARIABLE_SUBMIT_FUNCTIONALITY);
	...
	oFF.FeatureToggleOlap.MDS_DISPLAY_ATTRIBUTES = oFF.FeatureToggleOlap.create("MdsDisplayAttributes", oFF.XVersion.MAX + 1);
...
{
	var newObj = new oFF.FeatureToggleOlap();
	var fullName = oFF.XStringUtils.concatenate2(oFF.FeatureToggleOlap.PREFIX_OLAP, name);
	newObj.setupFeatureToggle(fullName, xVersion);
	return newObj;
};
...
{
	var newObj = new oFF.FeatureToggleSAC();
	var fullName = oFF.XStringUtils.concatenate2(oFF.FeatureToggleSAC.PREFIX_SAC, name);
	newObj.setupFeatureToggle(fullName, xVersion);
	return newObj;
};
