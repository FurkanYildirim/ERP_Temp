...
oFF.UiServerEvent.prototype.createControlEventWithParams = function(uiContext, uiAppContainer, operation)
{
	...
	{
		var controlEvent = oFF.UiControlEvent.create(uiContext);
		this.deserializeEventInternal(controlEvent, operation, uiAppContainer);
		return controlEvent;
	}
...
oFF.UiServerEvent.prototype.createSelectionEvent = function(uiContext, uiAppContainer, operation)
{
	if (oFF.notNull(uiAppContainer) && oFF.notNull(uiContext))
	{
		var selectionEvent = oFF.UiSelectionEvent.create(uiContext);
		this.deserializeEventInternal(selectionEvent, operation, uiAppContainer);
...
oFF.UiServerEvent.prototype.createResizeEvent = function(uiContext, uiAppContainer, operation)
{
	if (oFF.notNull(uiAppContainer) && oFF.notNull(uiContext))
	{
		...
		this.deserializeEventInternal(resizeEvent, operation, uiAppContainer);
		return resizeEvent;
	}
	throw oFF.XException.createRuntimeException("Event handling failed! Missing uiContext or uiAppContainer. Check remote server events!");
};
oFF.UiServerEvent.prototype.createMoveEvent = function(uiContext, uiAppContainer, operation)
{
	if (oFF.notNull(uiAppContainer) && oFF.notNull(uiContext))
	{
		...
		this.deserializeEventInternal(moveEvent, operation, uiAppContainer);
		return moveEvent;
	}
	throw oFF.XException.createRuntimeException("Event handling failed! Missing uiContext or uiAppContainer. Check remote server events!");
};
oFF.UiServerEvent.prototype.createDropEventWithParams = function(uiContext, uiAppContainer, operation)
{
	if (oFF.notNull(uiAppContainer) && oFF.notNull(uiContext))
	{
		...
		this.deserializeEventInternal(dropEvent, operation, uiAppContainer);
		return dropEvent;
	}
	throw oFF.XException.createRuntimeException("Event handling failed! Missing uiContext or uiAppContainer. Check remote server events!");
};
oFF.UiServerEvent.prototype.createItemEventWithParams = function(uiContext, uiAppContainer, operation)
{
	if (oFF.notNull(uiAppContainer) && oFF.notNull(uiContext))
	{
		var itemEvent = oFF.UiItemEvent.create(uiContext);
		this.deserializeEventInternal(itemEvent, operation, uiAppContainer);
		return itemEvent;
	}
	throw oFF.XException.createRuntimeException("Event handling failed! Missing uiContext or uiAppContainer. Check remote server events!");
};
oFF.UiServerEvent.prototype.createKeyboardEvent = function(uiContext, uiAppContainer, operation)
{
	if (oFF.notNull(uiAppContainer) && oFF.notNull(uiContext))
	{
		...
		this.deserializeEventInternal(keyboardEvent, operation, uiAppContainer);
		return keyboardEvent;
	}
	throw oFF.XException.createRuntimeException("Event handling failed! Missing uiContext or uiAppContainer. Check remote server events!");
};
oFF.UiServerEvent.prototype.deserializeEventInternal = function(eventBase, operation, uiAppContainer)
{
...
oFF.UiServerEvOnDeselect.prototype.getEventType = function()
{
...
oFF.UiServerEvOnItemDelete.prototype.getEventType = function()
{
...
oFF.UiServerFramework.prototype = new oFF.UiFramework();
oFF.UiServerFramework.prototype._ff_c = "UiServerFramework";

oFF.UiServerFramework.create = function()
{
	var newIntance = new oFF.UiServerFramework();
	newIntance.setupInternal();
	return newIntance;
};
oFF.UiServerFramework.prototype.m_operations = null;
oFF.UiServerFramework.prototype.releaseObject = function()
{
	this.m_operations = oFF.XObjectExt.release(this.m_operations);
	oFF.UiFramework.prototype.releaseObject.call( this );
};
oFF.UiServerFramework.prototype.setupInternal = function()
{
	this.m_operations = oFF.PrFactory.createList();
};
oFF.UiServerFramework.prototype.getThemeParameter = function(paramName)
{
	return oFF.UiFramework.prototype.getThemeParameter.call( this , paramName);
};
oFF.UiServerFramework.prototype.getThemeParameterAsync = function(paramName)
{
	return oFF.UiFramework.prototype.getThemeParameterAsync.call( this , paramName);
};
oFF.UiServerFramework.prototype.announce = function(message, mode)
{
	var operation = this.addOperation(oFF.UiRemoteProtocol.OP_UI_FRAMEWORK_ANNOUNCE);
	...
	oFF.UiFramework.prototype.announce.call( this , message, mode);
};
oFF.UiServerFramework.prototype.fetchOprationSequence = function()
{
	var currentOperationSequence = this.m_operations;
	this.m_operations = oFF.PrFactory.createList();
	return currentOperationSequence;
};
oFF.UiServerFramework.prototype.addOperation = function(operationName)
{
	var action = this.m_operations.addNewList();
	action.addString(operationName);
	action.addNull();
	action.addNull();
	return action;
};
...
oFF.SphereServer.prototype.initializeProgramContainer = function(initData)
{
	...
	if (oFF.notNull(initData))
	{
		...
		uiAppContainer = oFF.UiServerPrgContainer.createAndRun(initData, this.m_environment, serverBase, this.TRACING);
		if (oFF.notNull(uiAppContainer))
		{
...
oFF.UiServerPrgContainer.createAndRun = function(initData, environment, serverBase, isTracingEnabled)
{
	var newObject = null;
	if (oFF.notNull(initData) && initData.isStructure())
	{
		newObject = new oFF.UiServerPrgContainer();
...
oFF.UiServerPrgContainer.prototype.m_serverUiFrameowrk = null;
oFF.UiServerPrgContainer.prototype.m_initData = null;
oFF.UiServerPrgContainer.prototype.m_environment = null;
...
oFF.UiServerPrgContainer.prototype.releaseObject = function()
{
	...
	this.m_serverUiFrameowrk = oFF.XObjectExt.release(this.m_serverUiFrameowrk);
	oFF.DfNameObject.prototype.releaseObject.call( this );
};
oFF.UiServerPrgContainer.prototype.setupContainer = function(initData, environment)
{
	...
	oFF.UiFramework.setInstance(this.newServerUiFramework());
};
...
oFF.UiServerPrgContainer.prototype.newServerUiFramework = function()
{
	this.m_serverUiFrameowrk = oFF.UiServerFramework.create();
	return this.m_serverUiFrameowrk;
};
...
oFF.UiServerPrgContainer.prototype.getContainerServerUiFramework = function()
{
	return this.m_serverUiFrameowrk;
};
oFF.UiServerPrgContainer.prototype.getPendingUiOperations = function()
{
	var pendingOperationList = this.getContainerServerUiMgr().fetchOprationSequence();
	if (oFF.isNull(pendingOperationList))
	{
		pendingOperationList = oFF.PrFactory.createList();
	}
	if (this.getContainerServerUiFramework() !== null)
	{
		pendingOperationList.addAll(this.getContainerServerUiFramework().fetchOprationSequence());
	}
...
oFF.UiServerPrgContainer.prototype.onItemDelete = oFF.noSupport;
oFF.UiServerPrgContainer.prototype.onDeselect = oFF.noSupport;
...
oFF.SphereClient.prototype.showInitialScreen = function()
{
	if (this.getGenesis() !== null)
	{
		...
		mainLayout.addNewItemOfType(oFF.UiType.SPACER);
...
oFF.SphereClient.prototype.processGetServerInfoResponse = function(responseJsonContent)
{
	...
	serverInfoFormPopup.addInput(null, this.m_remoteLocation, "Server", null, null);
	serverInfoFormPopup.addInput(null, versionStr, "Version", null, null);
	serverInfoFormPopup.addInput(null, this.getElapsedStringFromMillis(startTimeMillis, false), "Started", null, null);
...
oFF.SphereClient.prototype.prepareUiEvent = function(event, eventDef, ocpFunction)
{
	...
	var eventBase = event;
	eventBase.mapElementIds( function(controlToMap){
...
oFF.SphereClient.prototype.sendUiEvent = function(event, eventDef)
{
...
oFF.SphereClient.prototype.addOperation = function(paramList, opName, control)
{
	paramList.addString(opName);
	this.addControlRef(paramList, control);
};
oFF.SphereClient.prototype.addControlRef = function(paramList, control)
{
	var theId = null;
	var theName = null;
...
{
	oFF.DfUiContext.prototype.setHeaderToolbar.call( this , toolbar);
	return this.addControlPropertyOperation(oFF.UiProperty.HEADER_TOOLBAR, toolbar);
};
...
{
	oFF.DfUiContext.prototype.setHeaderPosition.call( this , headerPosition);
	return this.addConstantPropertyOperation(oFF.UiProperty.HEADER_POSITION, headerPosition);
};
oFF.UiServerControl.prototype.setGroupName = function(groupName)
{
	oFF.DfUiContext.prototype.setGroupName.call( this , groupName);
	return this.addStringPropertyOperation(oFF.UiProperty.GROUP_NAME, groupName);
};
oFF.UiServerControl.prototype.setGroupItems = function(groupItems)
{
	oFF.DfUiContext.prototype.setGroupItems.call( this , groupItems);
	return this.addBooleanPropertyOperation(oFF.UiProperty.GROUP_ITEMS, groupItems);
};
oFF.UiServerControl.prototype.setColorString = function(colorString)
{
	oFF.DfUiContext.prototype.setColorString.call( this , colorString);
	return this.addStringPropertyOperation(oFF.UiProperty.COLOR_STRING, colorString);
};
oFF.UiServerControl.prototype.setColorPickerDisplayMode = function(colorPickerDisplayMode)
{
	oFF.DfUiContext.prototype.setColorPickerDisplayMode.call( this , colorPickerDisplayMode);
	return this.addConstantPropertyOperation(oFF.UiProperty.COLOR_PICKER_DISPLAY_MODE, colorPickerDisplayMode);
};
oFF.UiServerControl.prototype.setColorPickerMode = function(colorPickerMode)
{
	oFF.DfUiContext.prototype.setColorPickerMode.call( this , colorPickerMode);
	return this.addConstantPropertyOperation(oFF.UiProperty.COLOR_PICKER_MODE, colorPickerMode);
};
oFF.UiServerControl.prototype.setKey = function(key)
{
	oFF.DfUiContext.prototype.setKey.call( this , key);
	return this.addStringPropertyOperation(oFF.UiProperty.KEY, key);
};
oFF.UiServerControl.prototype.setShowValueStateMessage = function(showValueStateMessage)
{
	oFF.DfUiContext.prototype.setShowValueStateMessage.call( this , showValueStateMessage);
	return this.addBooleanPropertyOperation(oFF.UiProperty.SHOW_VALUE_STATE_MESSAGE, showValueStateMessage);
};
oFF.UiServerControl.prototype.setHorizontalScrolling = function(horizontalScrolling)
{
	oFF.DfUiContext.prototype.setHorizontalScrolling.call( this , horizontalScrolling);
	return this.addBooleanPropertyOperation(oFF.UiProperty.HORIZONTAL_SCROLLING, horizontalScrolling);
};
oFF.UiServerControl.prototype.setVerticalScrolling = function(verticalScrolling)
{
	oFF.DfUiContext.prototype.setVerticalScrolling.call( this , verticalScrolling);
	return this.addBooleanPropertyOperation(oFF.UiProperty.VERTICAL_SCROLLING, verticalScrolling);
};
oFF.UiServerControl.prototype.setDisplayOnly = function(displayOnly)
{
	oFF.DfUiContext.prototype.setDisplayOnly.call( this , displayOnly);
	return this.addBooleanPropertyOperation(oFF.UiProperty.DISPLAY_ONLY, displayOnly);
};
oFF.UiServerControl.prototype.setFastNavigation = function(fastNavigation)
{
	oFF.DfUiContext.prototype.setFastNavigation.call( this , fastNavigation);
	return this.addBooleanPropertyOperation(oFF.UiProperty.FAST_NAVIGATION, fastNavigation);
};
oFF.UiServerControl.prototype.setFilterSuggests = function(filterSuggests)
{
	oFF.DfUiContext.prototype.setFilterSuggests.call( this , filterSuggests);
	return this.addBooleanPropertyOperation(oFF.UiProperty.FILTER_SUGGESTS, filterSuggests);
};
oFF.UiServerControl.prototype.setShowSuggestion = function(showSuggestion)
{
	oFF.DfUiContext.prototype.setShowSuggestion.call( this , showSuggestion);
	return this.addBooleanPropertyOperation(oFF.UiProperty.SHOW_SUGGESTION, showSuggestion);
};
oFF.UiServerControl.prototype.setMaxChips = function(maxChips)
{
	oFF.DfUiContext.prototype.setMaxChips.call( this , maxChips);
	return this.addIntegerPropertyOperation(oFF.UiProperty.MAX_CHIPS, maxChips);
};
...
oFF.UiServerControl.prototype.setInitialFocus = function(control)
{
	oFF.DfUiContext.prototype.setInitialFocus.call( this , control);
	this.addControlPropertyOperation(oFF.UiProperty.INITIAL_FOCUS, control);
	return this;
};
oFF.UiServerControl.prototype.setLabelledBy = function(control)
{
	oFF.DfUiContext.prototype.setLabelledBy.call( this , control);
	this.addControlPropertyOperation(oFF.UiProperty.LABELLED_BY, control);
	return this;
};
oFF.UiServerControl.prototype.openAt = function(control)
{
	oFF.DfUiContext.prototype.openAt.call( this , control);
	var params = this.addMethodOperation(oFF.UiMethod.OPEN_AT);
	if (oFF.notNull(params))
	{
...
oFF.UiServerControl.prototype.openAtPosition = function(posX, posY)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.OPEN_AT_POSITION);
	if (oFF.notNull(params))
	{
...
{
	oFF.DfUiContext.prototype.openAtDock.call( this , control, withKeyboard, dockMy, dockAt, dockOffset);
	var params = this.addMethodOperation(oFF.UiMethod.OPEN_AT_DOCK);
	if (oFF.notNull(params))
	{
		this._addContextOrNull(params, control);
...
oFF.UiServerControl.prototype.println = function(text)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.PRINTLN);
	if (oFF.notNull(params))
	{
		params.addString(text);
	}
...
oFF.UiServerControl.prototype.expandToLevel = function(level)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.EXPAND_TO_LEVEL);
	if (oFF.notNull(params))
	{
...
oFF.UiServerControl.prototype.scrollToControl = function(control, duration)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.SCROLL_TO_CONTROL);
	if (oFF.notNull(params))
	{
		this._addContextOrNull(params, control);
		params.addInteger(duration);
...
oFF.UiServerControl.prototype.scrollToIndex = function(index)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.SCROLL_TO_INDEX);
	if (oFF.notNull(params))
	{
...
oFF.UiServerControl.prototype.popToPage = function(page)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.POP_TO_PAGE);
	if (oFF.notNull(params))
	{
...
oFF.UiServerControl.prototype.maximize = function(animated)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.MAXIMIZE);
	if (oFF.notNull(params))
	{
...
oFF.UiServerControl.prototype.restore = function(animated)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.RESTORE);
	if (oFF.notNull(params))
	{
		params.addBoolean(animated);
	}
...
oFF.UiServerControl.prototype.hide = function(animated, refControl)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.HIDE);
	if (oFF.notNull(params))
	{
		params.addBoolean(animated);
...
oFF.UiServerControl.prototype.show = function(animated, refControl)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.SHOW);
	if (oFF.notNull(params))
	{
		params.addBoolean(animated);
		this._addContextOrNull(params, refControl);
...
oFF.UiServerControl.prototype.selectText = function(startIndex, endIndex)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.SELECT_TEXT);
	if (oFF.notNull(params))
	{
...
oFF.UiServerControl.prototype.fullscreen = function()
{
	...
	this.addMethodOperation(oFF.UiMethod.FULLSCREEN);
	return this;
};
oFF.UiServerControl.prototype.startReadLine = function(text, numOfChars)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.START_READ_LINE);
	if (oFF.notNull(params))
	{
		params.addString(text);
...
oFF.UiServerControl.prototype.addCssClass = function(cssClass)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.ADD_CSS_CLASS);
	if (oFF.notNull(params))
	{
...
oFF.UiServerControl.prototype.removeCssClass = function(cssClass)
{
	...
	var params = this.addMethodOperation(oFF.UiMethod.REMOVE_CSS_CLASS);
	if (oFF.notNull(params))
	{
		params.addString(cssClass);
	}
...
{
	oFF.DfUiContext.prototype.showResizerAtIndex.call( this , index);
	var params = this.addMethodOperation(oFF.UiMethod.SHOW_RESIZER_AT_INDEX);
	if (oFF.notNull(params))
	{
		params.addInteger(index);
	}
...
{
	oFF.DfUiContext.prototype.hideResizerAtIndex.call( this , index);
	var params = this.addMethodOperation(oFF.UiMethod.HIDE_RESIZER_AT_INDEX);
	if (oFF.notNull(params))
	{
		params.addInteger(index);
	}
...
{
	oFF.DfUiContext.prototype.offset.call( this , offsetX, offsetY);
	var params = this.addMethodOperation(oFF.UiMethod.OFFSET);
	if (oFF.notNull(params))
	{
...
{
	var listener = this.getListenerOnItemDelete();
	if (oFF.notNull(listener))
	{
...
{
	var listener = this.getListenerOnDeselect();
	if (oFF.notNull(listener))
	{
...
oFF.UiServerControl.prototype.addMethodOperation = function(method)
{
