...
oFF.UiPrgContainer.prototype.m_initialControlToFocus = null;
...
oFF.UiPrgContainer.prototype.setInitialControlToFocus = function(control)
{
...
oFF.UiPrgContainer.prototype.getInitialControlToFocus = function()
{
...
oFF.DfUiProgram.prototype.proceedWithStartup = function(genesis)
{
	...
	else
	{
		...
		setupPromise.then( function(boolVal){
			...
			var errorMsg = oFF.XStringUtils.concatenate4("Failed to start ", this.getProgramName(), "! Error: ", error.getText());
...
{
	oFF.UiPrgContainerFloating.prototype.setInitialControlToFocus.call( this , control);
...
oFF.UiPrgContainerDialog.prototype.setInitialFocus = function()
{
	if (this.getDialog() !== null && this.getInitialControlToFocus() !== null)
	{
