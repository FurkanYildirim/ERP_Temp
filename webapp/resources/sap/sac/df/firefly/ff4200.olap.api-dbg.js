...
{
	var chartAlignment = new oFF.ChartAlignment();
...
oFF.ChartType.staticSetup = function()
{
	...
	oFF.ChartType.NONE = oFF.ChartType.create("None", null);
	oFF.ChartType.BAR_COLUMN = oFF.ChartType.create("BarColumn", "fpa/bar-rows");
	oFF.ChartType.POINT = oFF.ChartType.create("Point", null);
	oFF.ChartType.LINE = oFF.ChartType.create("Line", "fpa/line");
	oFF.ChartType.AREA = oFF.ChartType.create("Area", null);
	oFF.ChartType.BELL_CURVE = oFF.ChartType.create("BellCurve", null);
	oFF.ChartType.BOX_PLOT = oFF.ChartType.create("BoxPlot", null);
	oFF.ChartType.HISTOGRAM = oFF.ChartType.create("Histogram", null);
	oFF.ChartType.VIOLIN = oFF.ChartType.create("Violin", null);
	oFF.ChartType.BUBBLE = oFF.ChartType.create("Bubble", null);
	oFF.ChartType.PACKED_BUBBLE = oFF.ChartType.create("PackedBubble", null);
	oFF.ChartType.SCATTER_PLOT = oFF.ChartType.create("ScatterPlot", null);
	oFF.ChartType.SPLINE = oFF.ChartType.create("Spline", null);
	oFF.ChartType.TIME_SERIES = oFF.ChartType.create("TimeSeries", null);
	oFF.ChartType.METRIC = oFF.ChartType.create("Metric", null);
	oFF.ChartType.BULLET = oFF.ChartType.create("Bullet", null);
	oFF.ChartType.HEAT_MAP = oFF.ChartType.create("HeatMap", null);
	oFF.ChartType.TREE_MAP = oFF.ChartType.create("TreeMap", null);
	oFF.ChartType.DOUGHNUT = oFF.ChartType.create("Donut", "fpa/donut");
	oFF.ChartType.PIE = oFF.ChartType.create("Pie", "fpa/pie");
	oFF.ChartType.VARIABLE_PIE = oFF.ChartType.create("VariablePie", null);
	oFF.ChartType.VARI_WIDE = oFF.ChartType.create("VariWide", null);
	oFF.ChartType.RADAR = oFF.ChartType.create("Radar", null);
	oFF.ChartType.WATERFALL = oFF.ChartType.create("Waterfall", null);
	oFF.ChartType.WORD_CLOUD = oFF.ChartType.create("WordCloud", null);
...
oFF.ChartType.create = function(name, icon)
{
...
{
	var correspondingQueryModelAxis = this.m_feedToQueryModelAxis.getByKey(visualizationValueType);
...
{
	var valuesAsReadOnlyList = this.m_feedToQueryModelAxis.getValuesAsReadOnlyList();
	var keysAsReadOnlyList = this.m_feedToQueryModelAxis.getKeysAsReadOnlyList();
	for (var i = 0; i < valuesAsReadOnlyList.size(); i++)
	{
...
{
	var chartVerticalAlignment = new oFF.ChartVerticalAlignment();
...
{
	var object = new oFF.TableCellType();
...
{
	oFF.QGeoConstants.UNIVERSAL_AREA_SEMANTIC_TYPES = oFF.XListOfString.create();
