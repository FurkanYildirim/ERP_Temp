...
sap.ui.define([], function () {
  var __exports = Object.freeze({
    ...
    ERROR: {
      SHELL_CONTAINER_NOT_AVAILABLE: 'Illegal state: shell container not available; this component must be executed in a unified shell runtime context.',
