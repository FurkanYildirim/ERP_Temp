...
sap.ui.define(["./Renderer", "../common/Constants"], function (__Renderer, __Constants) {
  ...
  var Renderer = _interopRequireDefault(__Renderer);
  ...
  var ShellBarButton = /*#__PURE__*/function () {
    ...
    _createClass(ShellBarButton, null, [{
      key: "initShellBarButton",
      value: function initShellBarButton(resourceBundle, openSurveyCallback) {
        try {
          var _this = this;
          return Promise.resolve(Renderer.getRenderer()).then(function (renderer) {
            var headerItem = _this.getHeaderItem(resourceBundle, openSurveyCallback);
            renderer.addHeaderEndItem('sap.ushell.ui.shell.ShellHeadItem', headerItem, true);
          });
        } catch (e) {
