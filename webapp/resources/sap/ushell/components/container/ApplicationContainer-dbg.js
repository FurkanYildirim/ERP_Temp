    ...
    */
    ...
    function checkNwbcUrlAdjustment (oContainer, sApplicationType, sUrl, bForFramelessWindow) {
        ...
        if (utils.isApplicationTypeEmbeddedInIframe(sApplicationType) || (oContainer && utils.isApplicationTypeEmbeddedInIframe(oContainer.getFrameworkId()))) {
            ...
            sUrl = ApplicationContainer.prototype._adjustNwbcUrl(sUrl, sApplicationType, sTargetNavigationMode, oContainer && oContainer.getIsStateful(), bForFramelessWindow);
