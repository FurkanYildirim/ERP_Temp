    ...
    function generateWDAResolutionResult (oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver) {
        ...
        if (oPromise) {
            oPromise.then(function (oResult) {
                oResult.extendedInfo = getExtendedInfo(oMatchingTarget);
        ...
        return oSystemAlias.spliceSapSystemIntoURI(
            ...
            .then(function (oURI) {
                ...
                var oResolutionResult = {
                    ...
                    applicationType: "WCF",
                    fullWidth: true,
                    extendedInfo: getExtendedInfo(oMatchingTarget)
                };

                checkOpenWithPost(oMatchingTarget, oResolutionResult);
                addKeepAliveToURLTemplateResult(oResolutionResult);
        ...
        return new Promise(function (fnResolveGlobal) {
            ...
            createEnv().then(function (oEnv) {
                ...
                var sJamSearchPref = "/universal_search/search",
                    ...
                    JamInnerRoute;
                if (iJamSearchPos === 0) {
                    JamInnerRoute = window.location.hash.split("&/")[1];
                ...
                var oResult = {
                    ...
                    url: sURL,
                    extendedInfo: getExtendedInfo(oMatchingTarget, oTemplateContext.siteAppSection, oTemplateContext.site),
