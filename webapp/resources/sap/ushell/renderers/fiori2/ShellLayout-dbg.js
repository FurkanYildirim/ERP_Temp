...
sap.ui.define([
    ...
    function applyLayout (sRendererPlaceAtElementId) {
        ...
        var sHTMLTemplate = [
            ...
            "                <aside id='toolArea-shellArea' class='sapUshellPositionRelative' data-sap-ui-root-content=true></aside>",
            ...
            "                        <div id='floatingActions-shellArea' data-sap-ui-root-content=true></div>",
        ...
        if (bLayoutAlreadyApplied) {
            Log.warning("Found a ShellArea element. Did not apply the layout", "sap.ushell.renderers.fiori2.ShellLayout");
            return;
        }
