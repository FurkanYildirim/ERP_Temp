...
sap.ui.define([
    ...
    sap.ui.jsview("sap.ushell.renderers.fiori2.Shell", { // LEGACY API (deprecated)
         ...
         * Shell.view.js uses deprecated and synchronous APIs. It is replaced by ShellAsync.view.js
         *
        ...
        initBackgroundImage: function () {
            this.waitForShellLayout().then(function () {
                ...
                var sBackgroundHtml = [
                    ...
                    "<div class='sapUshellShellBGsapMShellBG sapUiGlobalBackgroundImage'></div>"
                ].join("\n");
