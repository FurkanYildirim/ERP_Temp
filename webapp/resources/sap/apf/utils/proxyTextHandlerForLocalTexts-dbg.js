...
sap.ui.define([
	...
	'sap/apf/utils/utils'
], function(exportToGlobal, Hashtable, parseTextPropertyFile, utils) {
	'use strict';
	/**
	 ...
	 * @constructor
	 * @alias sap.apf.utils.ProxyTextHandlerForLocalTexts
	 */
	...
	exportToGlobal("sap.apf.utils.ProxyTextHandlerForLocalTexts", ProxyTextHandlerForLocalTexts);
