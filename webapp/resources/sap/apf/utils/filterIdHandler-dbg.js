...
sap.ui.define([
...
], function(exportToGlobal, merge, jQuery){
	'use strict';
	/**
	 * @private
	 ...
	 * @alias sap.apf.utils.FilterIdHandler 
	 */
	function FilterIdHandler(inject) {
		...
		this.getAllInternalIds = function(id) {
			return merge([], internallyGeneratedIds);
		};
		/**
		 * @private
		 * @function
	...
	exportToGlobal("sap.apf.utils.FilterIdHandler", FilterIdHandler);
