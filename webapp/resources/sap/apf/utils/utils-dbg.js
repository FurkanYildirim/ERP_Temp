...
sap.ui.define([
...
], function(uiCoreDateFormat, Hashtable, UriParameters, ViewSettingsDialog, jQuery) {
	'use strict';
	...
	var utils = {
		...
		/**
		 * @description Returns the URL parameters. Is a wrapper function for the UriParameters class. For more details, please see SAPUI5 documentation
		 * @returns {object}
		 */
		getUriParameters: function() {
			var uriParams = UriParameters.fromQuery(window.location.search);
			return uriParams.mParams; // TODO access to private member mParams is strongly discouraged!
		},
		/**
