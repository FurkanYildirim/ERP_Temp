...
sap.ui.define([
	...
	var _setMessageDialogText = function(oCoreApi, dialogType) {
		if (dialogType === "naviagtionDialog") {
			Fragment.byId("idMessageDialogFragment", "idMessageDialog").setTitle(oCoreApi.getText("warning"));
			Fragment.byId("idMessageDialogFragment", "idYesButton").setText(oCoreApi.getText("yes"));
			Fragment.byId("idMessageDialogFragment", "idNoButton").setText(oCoreApi.getText("no"));
			Fragment.byId("idMessageDialogFragment", "idCancelButton").setText(oCoreApi.getText("cancel"));
		} else if (dialogType === "validationDialog") {
			Fragment.byId("idMandatoryValidationDialogFragement", "idMandatoryValidationDialog").setTitle(oCoreApi.getText("warning"));
			Fragment.byId("idMandatoryValidationDialogFragement", "idYesButton").setText(oCoreApi.getText("yes"));
			Fragment.byId("idMandatoryValidationDialogFragement", "idNoButton").setText(oCoreApi.getText("no"));
		}
	};
	var _openMessageDialogForSwitchState = function(configListInstance, switchState, callback) {
		...
		var oConfirmationMessageText = new Text();
	...
	var _openMessageDialogForValidationState = function(configListInstance, switchState, callback) {
		...
		var oValidationMessageText = new Text();
	...
	exportToGlobal("sap.apf.modeler.ui.utils.navigationHandler", navigationHandler);
