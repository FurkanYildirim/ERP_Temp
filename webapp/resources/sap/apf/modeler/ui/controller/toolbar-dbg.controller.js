...
sap.ui.define([
...
], function(Label, Text, Fragment, Popup, UIComponent, MVCController, Filter, FilterOperator, JSONModel, constants, SyncStyleClass){
	'use strict';
	...
	return MVCController.extend("sap.apf.modeler.ui.controller.toolbar", {
		...
		_setAddMenuText : function() {
			Fragment.byId("idAddMenuFragment", "idNewConfig").setText(this.oCoreApi.getText("newConfiguration"));
			Fragment.byId("idAddMenuFragment", "idNewFacetFilter").setText(this.oCoreApi.getText("newFacetFilter"));
			Fragment.byId("idAddMenuFragment", "idNewCategory").setText(this.oCoreApi.getText("newCategory"));
			Fragment.byId("idAddMenuFragment", "idNewNavigationTarget").setText(this.oCoreApi.getText("newNavigationTarget"));
			Fragment.byId("idAddMenuFragment", "idStep").setText(this.oCoreApi.getText("step"));
			Fragment.byId("idAddMenuFragment", "idNewStep").setText(this.oCoreApi.getText("newStep"));
			Fragment.byId("idAddMenuFragment", "idExistingStep").setText(this.oCoreApi.getText("existingStep"));
			Fragment.byId("idAddMenuFragment", "idHierarchicalStep").setText(this.oCoreApi.getText("hierarchicalStep"));
			Fragment.byId("idAddMenuFragment", "idNewRepresentation").setText(this.oCoreApi.getText("newRepresentation"));
		},
		/**
		 * @private
		 * @function
		...
		_setExistingStepDialogText : function() {
			Fragment.byId("idExistingStepDialogFragment", "idExistingStepDialog").setTitle(this.oCoreApi.getText("existingStepDialogTitle"));
		},
		/**
		 * @private
		 * @function
		...
		_copyConfiguration : function(sCopiedConfigurationId, newContextForCopiedNode) {
			...
			UIComponent.getRouterFor(this.oConfigListInstance).navTo(oConfigDetails.type, context, true);
		},
		/**
		 * @private
		 * @function
		...
		_openDeleteConfirmationDialog : function(sDialogMessage) {
			...
			var confirmationMessageText = new Text();
		...
		_setConfirmationDialogText : function() {
			Fragment.byId("idConfigConfirmationDialogFragment", "idDeleteConfirmation").setTitle(this.oCoreApi.getText("confirmation"));
			Fragment.byId("idConfigConfirmationDialogFragment", "idDeleteButton").setText(this.oCoreApi.getText("deleteButton"));
			Fragment.byId("idConfigConfirmationDialogFragment", "idCancelButtonDialog").setText(this.oCoreApi.getText("cancel"));
		},
		/**
		 * @private
		 * @function
