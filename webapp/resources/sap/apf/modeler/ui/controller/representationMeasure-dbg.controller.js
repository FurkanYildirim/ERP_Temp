...
sap.ui.define([
	...
	"sap/apf/utils/utils"
], function(BaseController, DisplayOptionsValueBuilder, textManipulator, constants, utils) {
	"use strict";
	/* BEGIN_COMPATIBILITY */
	...
	return BaseController.extend("sap.apf.modeler.ui.controller.representationMeasure", {
		...
		createNewPropertyInfoAsPromise : function(sNewProperty) {
			...
			return utils.createPromise(oNewPropertyInfo);
		},
		/**
