	...
	return BaseController.extend("sap.apf.modeler.ui.controller.configuration", {
		...
		handleChangeForFilterType : function() {
			...
			if (!oController.configurationEditor.isDataLostByFilterOptionChange()) {
				...
				oFilterOptionChangeDialog.setState(ValueState.Warning);
				oFilterOptionChangeDialog.setTitle(oController.textReader("warning"));
				Fragment.byId("idFilterOptionChangeFragment", "idLabelForDialog").setText(oController.textReader("filterOptionChangeMessage"));
				Fragment.byId("idFilterOptionChangeFragment", "idBeginButtonForDialog").setText(oController.textReader("continue"));
				Fragment.byId("idFilterOptionChangeFragment", "idEndButtonForDialog").setText(oController.textReader("cancel"));
		...
		handleBeginButtonDialogWithTwoButtons : function() {
			...
			_updateFilterOptionType(oController);
			oController.getView().getViewData().updateTree(); // Updates the tree structure according to chosen filter option type
			Fragment.byId("idFilterOptionChangeFragment", "idDialogWithTwoButtons").destroy();
		},
