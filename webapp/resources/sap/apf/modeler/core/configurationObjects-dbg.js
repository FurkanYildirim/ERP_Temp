...
sap.ui.define([
	...
	/**
	 * @private
	 * @alias sap.apf.modeler.core.ConfigurationObjects
	 ...
	 * @constructor
	 */
	function ConfigurationObjects(inject) {
	 ...
	 */
	ConfigurationObjects.deepDataCopy = function deepDataCopy(inputData) {
		var resultData;
		if (!inputData) {
	 ...
	 */
	ConfigurationObjects.getTextKeysFromConfiguration = function getTextKeysFromConfiguration(configuration) {
		var resultValue = [];
		if (!configuration) {
			return undefined;
		}
	...
	exportToGlobal("sap.apf.modeler.core.ConfigurationObjects", ConfigurationObjects);
