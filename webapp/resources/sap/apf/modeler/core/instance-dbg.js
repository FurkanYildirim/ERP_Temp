...
sap.ui.define([
	...
	function Instance(persistenceConfiguration, inject) {
		...
		var datajs;
		//constructors
		ApplicationHandler = (inject && inject.constructors && inject.constructors.ApplicationHandler) || DefaultApplicationHandler;
		...
		Step = (inject && inject.constructors && inject.constructors.Step) || DefaultStep;
