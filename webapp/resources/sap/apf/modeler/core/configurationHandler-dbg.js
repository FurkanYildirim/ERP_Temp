...
sap.ui.define([
...
], function(configurationEditor, exportToGlobal, hashtable, utils, configurationObjects) {
	"use strict";
	/**
	 * @private
	 ...
	 * @alias sap.apf.modeler.core.ConfigurationHandler
	 */
	function ConfigurationHandler(inject) {
		var that = this;
		...
		*/
		...
		function getTempId() {
			return "apf1972-" + (utils.createPseudoGuid(32));
		}
	}

	// compatiblity export as the global name and the module name differ
	exportToGlobal("sap.apf.modeler.core.ConfigurationHandler", ConfigurationHandler);
