...
sap.ui.define([
           ...
           ], function(hashtable, filter, DateFormat, exportToGlobal, utils, jQuery) {
               "use strict";
	/**
	 * @private 
	 ...
	 * @param {object} inject.instances  Injection of required instances
	 ...
	 * @alias sap.apf.modeler.core.TextPool
	 */
	function TextPool(inject, applicationId, existingTexts) {
		...
		this.exportTexts = function(analyticalConfigurationName) {
			...
			return textPropertyFile + utils.renderTextEntries(hashTableForTexts, messageHandler) 
				+ utils.renderEntryOfTextPropertyFile(textEntryForAnalyticalConfigurationName, messageHandler);
		};
		/**
	...
	exportToGlobal("sap.apf.modeler.core.TextPool", TextPool);
