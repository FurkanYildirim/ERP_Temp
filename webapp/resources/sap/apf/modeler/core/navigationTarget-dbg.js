...
sap.ui.define([
	...
	/**
	 * @private
	 * @alias sap.apf.modeler.core.navigationTarget
	 ...
	 * @param {object} inject - Injected dependencies
	 ...
	 * @constructor
	 */
	function NavigationTarget(navigationTargetId, inject, dataFromCopy) {
	...
	exportToGlobal("sap.apf.modeler.core.NavigationTarget", NavigationTarget);
