...
sap.ui.define([
...
], function(exportToGlobal, jQuery) {
	'use strict';
	/**
	 * @private
	 * @alias sap.apf.modeler.core.FacetFilter
	 ...
	 * @constructor
	 */
	function FacetFilter(facetFilterId, inject, dataFromCopy) {
		...
		this.copy = function(newIdForCopy) {
			...
			return new FacetFilter((newIdForCopy || this.getId()), inject, dataFromCopy);
		};
	}

	// compatiblity export as the global name and the module name differ
	exportToGlobal("sap.apf.modeler.core.FacetFilter", FacetFilter);
