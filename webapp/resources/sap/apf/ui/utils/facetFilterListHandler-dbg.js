...
sap.ui.define([
	 ...
	 * @alias sap.apf.ui.utils.FacetFilterHandler
	 ...
	 */
	function FacetFilterListHandler(oCoreApi, oUiApi, oConfiguredFilter) {
		"use strict";
		...
		* */
		...
		this.createFacetFilterList = function () {
			...
			oFacetFilterList.bindItems("/", new FacetFilterItem({
				key : '{key}',
				text : '{text}',
				selected : '{selected}'
			}));
	...
	exportToGlobal("sap.apf.ui.utils.FacetFilterListHandler", FacetFilterListHandler);

	return FacetFilterListHandler;
});