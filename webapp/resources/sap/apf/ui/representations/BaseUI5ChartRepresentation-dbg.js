		...
		getSortedSelections : function() {
			...
			switch (labelDisplayOption) {
				case coreConstants.representationMetadata.labelDisplayOptions.TEXT:
					return utils.sortByProperty(selections, "text", this.metadata.getPropertyMetadata(propertyMetadata.text));
				case coreConstants.representationMetadata.labelDisplayOptions.KEY_AND_TEXT:
					return utils.sortByProperty(selections, "text");
				default:
					return utils.sortByProperty(selections, "id", propertyMetadata);
			}
		},
