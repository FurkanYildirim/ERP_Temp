sap.ui.define([
	...
	], function (Device, Controller, Ui5Filter, FilterOperator, JSONModel, jQuery){
	"use strict";
	/**
	...
	return Controller.extend("sap.apf.ui.reuse.controller.pathFilterDisplay", {
		...
		onInit : function(){
			...
			this.getView().byId("stepPage").setTooltip(this.getCoreApi().getTextNotHtmlEncoded("pathFilterDisplay-SelectedFilters"));
