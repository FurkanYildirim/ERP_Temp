...
sap.ui.define([
...
], function(constants, filter, filterTerm, exportToGlobal, jQuery) {
	"use strict";
	 ...
	 * @alias sap.apf.core.Binding
	 */
	function Binding(oInject, oBindingConfig, oFactory, sRepresentationId) {
		var that = this;
		this.type = "binding";
	...
	exportToGlobal("sap.apf.core.Binding", Binding);
