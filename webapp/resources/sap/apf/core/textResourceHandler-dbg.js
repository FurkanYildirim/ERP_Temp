...
sap.ui.define([
...
], function(exportToGlobal, Hashtable, jQuery, encodeXML, formatMessage, UI5ResourceModel) {
	"use strict";
	/**
	 ...
	 * @alias sap.apf.core.TextResourceHandler
	 */
	function TextResourceHandler(oInject) {
		var oMessageHandler = oInject.instances.messageHandler;
		var resourceBundle;
		var oHashedTextElements = new Hashtable(oMessageHandler);
		var oHashedDatabaseTextElements = new Hashtable(oMessageHandler);
		var oHashedInvalidKeys =  new Hashtable(oMessageHandler);
		var registeredTexts = {};
		var ResourceModel = ( oInject.constructors &&  oInject.constructors.ResourceModel ) || UI5ResourceModel;
		var oResourceModel;
		/**
	...
	exportToGlobal("sap.apf.core.TextResourceHandler", TextResourceHandler);
