...
sap.ui.define([
...
], function(FilterTerm, constants, Ui5Filter, utils, jQuery){
	'use strict';
	/**
	 * @private
	...
	Filter.createEmptyFilter = function(oMsgHandler, aProperties) {
		oMsgHandler.check(Array.isArray(aProperties) && aProperties.length > 0, "sap.apf.core.utils.Filter.createEmptyFilter - array with property names expected");
