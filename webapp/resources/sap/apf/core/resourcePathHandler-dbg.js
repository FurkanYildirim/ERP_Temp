...
sap.ui.define([
	 ...
	 * @alias sap.apf.core.ResourcePathHandler
	 */
	function ResourcePathHandler(oInject) {
		...
		var oHT = new Hashtable(messageHandler);
		...
		function loadAnalyticalConfigurationAndRessources() {
			...
			var baseComponentUri = uriGenerator.getBaseURLOfComponent(utils.getComponentNameFromManifest(oInject.manifests.baseManifest));
			var componentUri = uriGenerator.getBaseURLOfComponent(utils.getComponentNameFromManifest(oInject.manifests.manifest));
			...
			var titleKey = utils.createPseudoGuid();
	...
	exportToGlobal("sap.apf.core.ResourcePathHandler", ResourcePathHandler);
