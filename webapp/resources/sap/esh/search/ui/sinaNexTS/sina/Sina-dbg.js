    ...
    _createClass(Sina, [{
      ...
      value: function createStaticHierarchySearchNavigationTarget(hierarchyNodeId, hierarchyNodeLabel, dataSource, navigationTargetLabel, hierarchyNodeAttributeName) {
        if (!hierarchyNodeAttributeName) {
          ...
          if (!hierarchyNodeAttributeName) {
            if (dataSource.hierarchyHelperDatasource && dataSource.hierarchyHelperDatasource.hierarchyAttribute) {
              hierarchyNodeAttributeName = dataSource.hierarchyHelperDatasource.hierarchyAttribute;
            } else {
              return null;
            }
          }
