...
sap.ui.define([
	...
	WorklistHandler, ShareUtils, controlHelper, FeLogger, ObjectPath, StableIdHelper, deepExtend, CreateWithDialogHandler, MultiEditHandler, SelectionVariant, AddCardsHelper, filterSettingsPreparationHelper, JSONModel, MessageBox) {
	"use strict";
						...
						oTemplateUtils.oServices.oApplication.performAfterSideEffectExecution(function(){
							...
							if (oState.oSmartFilterbar.getUiState().getSemanticDates() || tableFiltersActive || !bIsSimpleColumnsApplied) {
								MessageBox.error(oRb.getText("ST_CARD_CREATION_FAILURE"), {
									...
									"<li>" + oRb.getText("ST_CARD_FAILURE_TABLE_REASON_UNSUPPORTED_COLUMNS") + "</li>" +
								...
								var oCardManifest = AddCardsHelper.createCardForPreview(oCardDefinition);
								oInsightsInstance.showCardPreview(oCardManifest, true);
							}
						}, true);
					},
