	...
	GanttHeader.prototype.renderElement = function() {
		...
		var nHalfHeaderHeight, nFirstRowYOffset, nSmallIntervalTextY;
			...
			if (
				...
				aLines = GanttUtils.calculateLevelForShapes(aDeltaLines.concat(aAdhocLines), "timeStamp", "endTimeStamp", true);
				...
				aLines = GanttUtils.calculateLevelForShapes(aAdhocLines, "timeStamp", "endTimeStamp", true);
				...
				maxLevelAdhocLines = Math.max.apply(
					...
					oGantt.getEnableDeltaLine() === true ) {
					aLines = GanttUtils.calculateLevelForShapes(aDeltaLines, "timeStamp", "endTimeStamp", true);
