sap.ui.define([
	...
	var AstExpressionBasic = ExpressionBase.extend("sap.rules.ui.AstExpressionBasic", {
		...
		_setUpEventHandlers: function () {
			...
			var isMac = sap.ui.Device.os.name === "mac";
			this.aKeyTracker = [];
			if (!this._focusedOut) {
			...
			this._input.on('keyup', function (event) {
				...
				if (event.key === "Control" || (sap.ui.Device.os.name === "mac" && event.key === "Alt") || event.keyCode === 35 || event.keyCode === 36 || event.keyCode === 37 || event.keyCode === 39 || event.keyCode === 20 || event.keyCode === 144) {
					return;
				}
