...
import ActionRuntime, { ActionParameterInfo } from "sap/fe/core/ActionRuntime";
...
import deleteHelper, { DeleteOption } from "sap/fe/core/helpers/DeleteHelper";
			...
			const oController = {
				...
				*/
				handleChange: async (event: Event) => {
					...
					actionParameterInfo.validationPromise = event.getParameter("promise") as Promise<string>;
					try {
