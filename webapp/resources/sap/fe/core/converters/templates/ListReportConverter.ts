...
const getView = function (viewConverterConfiguration: ViewConverterSettings, isInsightsEnabled?: boolean): ListReportViewDefinition {
 ...
 */
export const convertPage = function (converterContext: ConverterContext, isInsightsEnabled?: boolean): ListReportDefinition {
	const entityType = converterContext.getEntityType();
	...
	const views: ListReportViewDefinition[] = getViews(converterContext, viewsDefinition, isInsightsEnabled);
