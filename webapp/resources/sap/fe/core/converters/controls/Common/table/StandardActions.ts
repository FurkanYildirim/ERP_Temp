...
import { getInsightsVisibility } from "../../../helpers/InsightsHelpers";
...
export function getStandardActionInsights(
	...
	const insightsVisibility =
		(standardActionsContext.isInsightsEnabled ?? false) &&
		getInsightsVisibility("Table", converterContext, visualizationPath, standardActionsContext);
