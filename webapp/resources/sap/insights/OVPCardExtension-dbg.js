...
sap.ui.define(
    ...
    function (Extension, NumberFormat, SelectionVariant, Log, DateFormat, coreLibrary, mobileLibrary, OVPChartFormatter, IntegrationUtils, DynamicDateUtil, UI5Date) {
        "use strict";
        ...
        function addPropertyValueToAppState(oNavData, oContext) {
            var oCard = this.getEventingParent().getManifest()["sap.card"],
