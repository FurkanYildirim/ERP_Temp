...
sap.ui.define(
    ...
    function (Extension, NumberFormat, SelectionVariant, Log, DateFormat, coreLibrary, mobileLibrary, IntegrationUtils, DynamicDateUtil, Core, NavError, UrlGenerateHelper, AppConstants, UI5Date) {
        "use strict";
        ...
        return Extension.extend("sap.insights.CardExtension", {
            ...
            loadDependencies: function() {
                ...
                if (sType === "Analytical") {
                    aPromises.push(Core.loadLibrary("sap.viz", { async: true })
                        .then(function () {
