        ...
        function processPrivateParams(oCard, oParams, bCardExtension) {
            ...
            aParams.forEach(function (sParamName) {
              ...
              if (oCardParams[sParamName].value) {
                if (oCardParams[sParamName].value.value) {
              ...
              if (oCardParams[sParamName].type === "datetime" && !aSemanticDateFields.includes(sParamName) && !paramVal.includes("datetime")){
                ...
                paramVal = typeof oCardParams[sParamName].value === "string" && Date.parse(oCardParams[sParamName].value) ? formatSemanticDateTime(UI5Date.getInstance(paramVal), "Parameter") : formatSemanticDateTime(paramVal, "Parameter");
