...
function (
    ...
    function setSapui5Settings (oSettings, oCurrencyFormats) {
        ...
        if (oSettings.useTimeZoneIana && oSettings.timeZoneIana !== "") {
            Configuration.setTimezone(oSettings.timeZoneIana);
        }
    }
    ...
    function processStartup (oStartupResult) {
        ...
        bTimeZoneIana = ObjectPath.get("sap-ushell-config.ui5.timeZoneFromServerInUI5");
        if (bTimeZoneIana === undefined) {
            ObjectPath.set("sap-ushell-config.startupConfig.timeZoneFromServerInUI5", false);
            ObjectPath.set("ushell.ui5.timeZoneFromServerInUI5", false);
            bTimeZoneIana = ObjectPath.get("sap-ushell-config.startupConfig.timeZoneFromServerInUI5");
        }
        sTimeZoneIana = ObjectPath.get("sap-ushell-config.startupConfig.timeZone");
        if (sTimeZoneIana === undefined) {
            ObjectPath.set("sap-ushell-config.startupConfig.timeZone", "");
            sTimeZoneIana = ObjectPath.get("sap-ushell-config.startupConfig.timeZone");
        }
