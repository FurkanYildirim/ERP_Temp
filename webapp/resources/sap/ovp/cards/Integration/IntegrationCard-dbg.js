...
sap.ui.define([
    ...
    var addFilterPropertyDetails = function (
        ...
        if (oFilterProperty["PropertyName"] && oFilterProperty["PropertyName"]["PropertyPath"]) {
            var sKeyName = oFilterProperty["PropertyName"]["PropertyPath"],
                sTargetEntityname = oGlobalFilter && oGlobalFilter.getEntityType(),
                oFiltermodel = oGlobalFilter && oGlobalFilter.getModel(),
                oFilterMetaModel = oFiltermodel && oFiltermodel.getMetaModel(),
                oTargetEntityType = oFilterMetaModel.getODataEntityType(sTargetEntityname),
                bConsiderAnalyticParameters = oGlobalFilter.getConsiderAnalyticalParameters();
    ...
    var getFilterDetails = function (oCardDefinition) {
            ...
            if (oFilterSetvalues.hasOwnProperty(sFilterId)) {
                ...
                if (sFilterId === "Parameters") {
                    ...
                    for (var k = 0; aFilterSet && k < aFilterSet.length; k++) {
                        ...
                        var oNavigationParameters = NavigationHelper.getNavigationParameters(oController, oCardDefinition);
        ...
        var aCustomFilters = Filterhelper.addCustomNavigationParametersToManifest(oCardDefinition, oFinal);
        ...
        oFinal["_customFilters"] = { value: aCustomFilters };
        return oFinalSet;
    };
