...
sap.ui.define([
    ...
    function formatItems(iContext, oEntitySet) {
        ...
        var aFilters = CardAnnotationHelper.getFilters(oModel, oSelectionVariant, true);
    ...
    function getAggregateNumber(iContext, oEntitySet, oDataPoint, oSelectionVariant) {
        ...
        var aFilters = CardAnnotationHelper.getFilters(oOvpCardSettings, oSelectionVariant, true);
