        ...
        var customFormatter = {
            ...
            format: function (value, pattern) {
                ...
                if (patternArr.length > 0) {
                    ...
                    if (patternArr[0] === "ShortFloat_MFD2") { // Internal Incident: 2380034448, do not preserve decimal if pattern is ShortFloat_MFD2
                        var numberFormat;
    ...
    */
    ...
    function getChartTitle(oEntityType, sChartAnnotationPath, oVizFrame) {
        ...
        if (oEntityTypeTitle) {
            ...
            var oI18nModel = oVizFrame.getModel("@i18n") ? oVizFrame.getModel("@i18n") : oVizFrame.getModel("i18n");
