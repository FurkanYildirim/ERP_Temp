...
sap.ui.define([
	...
	ValueListProvider.prototype._createDropDownTemplate = function() {
		var aTextParts = [
			...
			oParent = this.oControl.getParent();
		...
		if (this.sContext === "SmartField" && oParent && oParent.getDataProperty() && MetadataAnalyser.getIsTimezoneProperty(oParent.getDataProperty().property)) {
	...
	ValueListProvider.prototype._updateDescriptionIfRequired = function (oSettings) {
		if (!this.bInitialised ||
			!oSettings.forceTextArrangementFetch) {
			return;
		}
